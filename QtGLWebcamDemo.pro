...
contains(ANDROID_TARGET_ARCH,armeabi) {
    ...
    INCLUDEPATH += /mnt/Signi/Softwares/Linux/OpenCV-2.4.9-android-sdk/sdk/native/jni/include/ \
/mnt/Signi/Softwares/Linux/OpenCV-2.4.9-android-sdk/sdk/native/jni/include/opencv \
/mnt/Signi/Softwares/Linux/OpenCV-2.4.9-android-sdk/sdk/native/jni/include/opencv2 \
}

contains(ANDROID_TARGET_ARCH,armeabi-v7a) {
    LIBS += -l$$ANDROID_PACKAGE_SOURCE_DIR/libs/armeabi-v7a/libopencv_java.so \
        -l$$ANDROID_PACKAGE_SOURCE_DIR/libs/armeabi-v7a/libopencv_info.so \
        -l$$ANDROID_PACKAGE_SOURCE_DIR/libs/armeabi-v7a/libnonfree.so
